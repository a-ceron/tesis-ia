...
# Es una operación entre matrices con producto interno
def gram_matrix(img):
    # Gram matrix es la multiplicación de la imagen por su transpuesta
...
# La perdida es mean square con las matrices de gram
def style_loss(y, t):
    return K.mean(K.square(gram_matrix(y) - gram_matrix(t)))

# Acá hacemos el entenamiento del modelo
...
if __name__ == '__main__':
    path = '/Users/aceron/Library/CloudStorage/GoogleDrive-arielcerong@gmail.com/Mi unidad/Aprendizaje/Tesis/Maestría/Code/master-degree/TensorFlow/data/myDataSet/RandomImages/style.jpg'
    img = load_img(path)
